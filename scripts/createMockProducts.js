 ...
 * 
 * Usage: 
 *   1. Get a seller user ID from Firebase Console
 *   2. Run: node scripts/createMockProducts.js <sellerId>
 * 
 * Example:
 *   node scripts/createMockProducts.js abc123xyz456
 */
...
async function createMockProducts(sellerId) {
  ...
  if (!sellerId || sellerId.trim() === '') {
    ...
    console.log('\nUsage:');
    console.log('  node scripts/createMockProducts.js <sellerId>');
    console.log('\nTo get a sellerId:');
    console.log('  1. Log in as a seller user in your app');
    console.log('  2. Check Firebase Console > Authentication > Users');
    console.log('  3. Copy the User UID (this is the sellerId)');
